// pages/room_oblmon/room_oblmon.js
var app = getApp();
Page({
   ...
   */
  data: {
    room_ding: { roomtitles: '待付款', roomadds: '还剩23小时59分自动关闭', showView: false, showViews: false, showViewes: false, picurl: app.data.picurl,},
