// pages/room_drawcar/room_drawcar.js
var app = getApp();
Page({
   ...
   */
  data: {
    room_ding: { roomtitles: '待取车', roomadds: '取车时间：10月25日', showView: false, showViews: false, showViewes: false, picurl: app.data.picurl,},
